...
- JNE3797, J0230, SET268 are top 3 styles generating revenue of 2.4m, 1.8m, 1.2m.
- Most ordered category is SET in Apr, May, Jun followed by kurta
- JNE3797 in sizes S, M, L, and XL is the most liked style, followed by J0230.
- The most cancelled categories are Set (16%), Kurta (16%), and Western Dress (15%).
- In terms of volume, the most cancelled sizes are XS (18%), S (16%), M (16%), and L (15%), while 6XL, 5XL, and 4XL show the highest cancellation rates (>75%).
- The Average Order Value (AOV) is higher for B2B (₹703) than for B2C (₹660).
- SET195, JNE3475, JNE3608 are most cancelled products. 
- Most successful category of order fulfilment is Dupatta with 100% successful order without return or cancellation.
